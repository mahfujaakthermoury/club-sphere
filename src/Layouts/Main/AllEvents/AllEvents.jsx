...
const AllEvents = () => {
  ...
  const {
    ...
    queryKey: ["events", search, category, sortBy, order, page],
    queryFn: async () => {
  ...
  return (
    ...
    >
      <HeadProvider>
        <Title>All Events || ClubSphere</Title>
      </HeadProvider>
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        >          Discover vibrant club events from different categories and become part of something meaningful.</p>
